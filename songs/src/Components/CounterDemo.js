<script type="text/babel" data-plugins="proposal-class-properties" data-presets="env,react">
    ...
    class Counter extends React.Component {
        render (){
            return(
            <div>
                <button className="increment" onClick={this.onClick = () => this.props.increment()}>Increment</button>
                <button className="decrement" onClick={this.onClick = () => this.props.decrement()}>Decrement</button>
